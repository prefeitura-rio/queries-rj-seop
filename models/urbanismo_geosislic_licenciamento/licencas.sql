...
SELECT 
    ...
    SAFE_CAST(qtd_num_proc AS INT64) processos, 
    SAFE_CAST(qtd_licencas AS INT64) licencas, 
    SAFE_CAST(qtd_edificacoes AS INT64) edificacoes, 
    ...
    SAFE_CAST(area_unid_total AS FLOAT64) area_total, # verificar metadado
    SAFE_CAST(area_unid_residencial AS FLOAT64) area_residencial, 
    SAFE_CAST(area_unid_resid_uni AS FLOAT64) area_residencial_unifamiliar, 
    SAFE_CAST(area_unid_resid_bi AS FLOAT64) area_residencial_bifamiliar, 
    SAFE_CAST(area_unid_resid_multi AS FLOAT64) area_residencial_multifamiliar, 
    SAFE_CAST(area_unid_comercial AS FLOAT64) area_comercial, 
    SAFE_CAST(area_unid_lojas AS FLOAT64) area_lojas,
    SAFE_CAST(area_unid_salas AS FLOAT64) area_salas, 
    SAFE_CAST(area_unid_uso_exclusivo AS FLOAT64) area_uso_exclusivo, 
    SAFE_CAST(area_unid_industrial AS FLOAT64) area_industrial, 
    SAFE_CAST(area_unid_outros AS FLOAT64) area_outros, 
    SAFE_CAST(qtd_unid_total AS INT64) total, 
    SAFE_CAST(qtd_unid_residencial AS INT64) residencial, 
    SAFE_CAST(qtd_unid_resid_uni AS INT64) residencial_unifamiliar, 
    SAFE_CAST(qtd_unid_resid_bi AS INT64) residencial_bifamiliar, 
    SAFE_CAST(qtd_unid_resid_multi AS INT64) residencial_multifamiliar, 
    SAFE_CAST(qtd_unid_nao_residencial AS INT64) nao_residencial, 
    SAFE_CAST(qtd_unid_comercial AS INT64) comercial, 
    SAFE_CAST(qtd_unid_lojas AS INT64) lojas, 
    SAFE_CAST(qtd_unid_salas AS INT64) salas, 
    SAFE_CAST(qtd_unid_uso_exclusivo AS INT64) uso_exclusivo, 
    SAFE_CAST(qtd_unid_industrial AS INT64) industrial, 
    SAFE_CAST(qtd_unid_outros AS INT64) outros, 
